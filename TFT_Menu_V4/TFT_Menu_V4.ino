...
struct Options_List{
  uint8_t* main_option;
  struct Sub_Option_List Sub_Option[10];
...
void setup() {
 ...
 Opt[1].Sub_Option[0].sub_option_list[0] = "OFF";
 ...
 Opt[1].Sub_Option[5].sub_option = "[Return]";
...
void Enter_Button()
{
  ...
  if(button == 10)
  {
    ...
    for(int i=0; i< Opt[set_point].no_sub_option;i++)
    {
       my_lcd.Set_Text_Size(2);
       my_lcd.Print_String(space, 170, my_lcd.Get_Display_Height()*(0.3+i*0.1));
       my_lcd.Print_String(Opt[set_point].Sub_Option[i].sub_option, 170, my_lcd.Get_Display_Height()*(0.3+i*0.1));
    }
    }
        ...
        for(int i=0; i< Opt[set_point].no_sub_option-set_point_enter; i++)
         {
          my_lcd.Set_Text_Size(2);
          my_lcd.Print_String(space, 170, my_lcd.Get_Display_Height()*(0.3+i*0.1));
          my_lcd.Print_String(Opt[set_point].Sub_Option[set_point_enter+i].sub_option, 170, my_lcd.Get_Display_Height()*(0.3+i*0.1));
         } 
      ...
      for(int i=0; i<MAX_VISIBLE; i++)
         {
          my_lcd.Set_Text_Size(2);
          my_lcd.Print_String(space, 170, my_lcd.Get_Display_Height()*(0.3+i*0.1));
          my_lcd.Print_String(Opt[set_point].Sub_Option[abs(set_point_enter-MAX_VISIBLE)-1+i].sub_option, 170, my_lcd.Get_Display_Height()*(0.3+i*0.1));
         } 
         flag_up = 0;
    }
