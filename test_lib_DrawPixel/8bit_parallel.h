#define RD_MASK 0x00001000 //define RD_MASK HEX VALUE here  RES : GPIO12
#define WR_MASK 0x00000800  //define WR_MASK HEX VALUE here   CS : GPIO11
#define CD_MASK 0x00000400  //define CD_MASK HEX VALUE here   CD : GPIO10
#define CS_MASK 0x00000200  //define CS_MASK HEX VALUE here   WRITE : GPIO9
#define RES_MASK 0x00000100  //define RES_MASK HEX VALUE here   READ : GPIO8
...
#define write8(d) { write_word(GPIO_DATA_REG,(*GPIO_DATA_REG&~DATA_MASK) | (d & DATA_MASK));WR_STROBE }
